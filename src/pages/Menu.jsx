		...
		<div className="bg-dark text-secondary min-h-screen px-8">
			<header className="w-full px-4 py-8 bg-primary/20 rounded-b-xl text-secondary top-0">
				<div className="flex flex-col md:flex-row justify-between">
					...
					<nav className="inline-flex items-center justify-center">
						<Link
							to="settings"
							className="mr-2 flex items-center justify-center p-2 hover:bg-secondary-400/25 rounded-full hover:text-secondary-400"
						>
			...
			<section className="container mx-auto px-4 py-12">
				<div className="grid grid-cols-3 gap-4">
					<Link
						to={`tv`}
						className="h-96 bg-secondary rounded-xl text-center text-xl justify-center flex items-center text-dark"
					>
					...
					<Link
						to={`movies`}
						className="h-96 bg-blue-400 rounded-xl text-center text-xl justify-center flex items-center"
					>
