	...
	return (
		<div className="relative min-h-screen overflow-hidden bg-dark text-secondary">
			...
			<div className="pointer-events-none absolute inset-0">
				<div className="absolute -top-40 left-1/2 h-[36rem] w-[36rem] -translate-x-1/2 rounded-full bg-secondary-400/10 blur-3xl animate-pulse-slow" />
				<div className="absolute bottom-0 right-0 h-96 w-96 rounded-full bg-primary/20 blur-3xl animate-pulse-slow" style={{ animationDelay: "2s" }} />
			</div>
			...
			<div className="fade-in relative mx-auto flex min-h-screen max-w-6xl flex-col items-center justify-center px-6 py-16">
				<header className="mb-12 flex flex-col items-center text-center">
					<h1 className="text-5xl font-bold tracking-tight text-white">
						Open<span className="text-gradient">IPTV</span>
					</h1>
